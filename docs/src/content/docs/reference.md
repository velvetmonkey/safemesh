...
This generated reference records **API present** in the source used for this build. It makes no claim about **artifact available**, **build checked**, **runtime tested**, **integration tested**, or **maintainer-supported** for any listed item. Consult the [claims and evidence guide](/claims/) for evidence beyond API presence.

## Rust core

[Open the generated `safemesh-crdt` reference](/reference/rust/safemesh_crdt/index.html).
