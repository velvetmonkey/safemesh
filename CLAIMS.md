...
- Canonical wire encoding, binding glue, FFI, WASM, Python, demos, and storage or transport adapters are engineered and tested. They must call the Rust core rather than reimplementing merge semantics.
