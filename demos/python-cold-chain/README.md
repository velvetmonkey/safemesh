...
The G-Counter audit path reaches the Lean-backed Rust carrier. The LWW Map custody path, Enable-wins Flag alert path, and the Python binding glue are engineered and tested product surfaces, not separate Lean proofs in v0.2.
