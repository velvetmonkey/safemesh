...
fn convergence_harness_hammers_delta_delivery_shapes() {
    let report = check_crdt_convergence(
        &GCounter::new(4),
        &[
            GCounterDelta {
                replica: 0,
    ...
    .unwrap();
    println!("GCounter convergence scenarios: {}", report.scenarios);
    ...
    .unwrap();
    println!("PnCounter convergence scenarios: {}", report.scenarios);
    ...
    .unwrap();
    println!("OrSet convergence scenarios: {}", report.scenarios);
    ...
    .unwrap();
    println!("Rga convergence scenarios: {}", report.scenarios);
    ...
    .unwrap();
    println!("LwwRegister convergence scenarios: {}", report.scenarios);
    ...
    .unwrap();
    println!("EnableWinsFlag convergence scenarios: {}", report.scenarios);
